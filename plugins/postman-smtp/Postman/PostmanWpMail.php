...
if (! class_exists ( "PostmanWpMail" )) {
	...
	class PostmanWpMail {
		 ...
		 * Exceptions are held for later inspection. An instance of PostmanState updates the success/fail tally.
		 *
		 * @param unknown $to        	
		...
		public function send($to, $subject, $message, $headers = '', $attachments = array()) {
			...
			// this is outside of sendMessage because MyMail creates its own body parts
